...
def train():
    ...
    # LABEL_ENCODE_DATA_PATH ='/Users/lahariboni/Desktop/PII-Data/dags/processed/label_encoder_data.json'
    # TEST_DATA_PATH='/Users/lahariboni/Desktop/PII-Data/dags/processed/test_data'
    # train_mapped = '/Users/lahariboni/Desktop/PII-Data/dags/processed/ds_data'
    train_mapped = r'C:\Users\siddh\OneDrive - Northeastern University\Desktop\NEU Essentials\03 Spring 24\00 IE7374 ML Ops\MLFlow\pii-new\PII-Data\dags\processed\train_data'

    train_mapped = load_from_disk(train_mapped)
    # PROJECT_DIR = os.getcwd()
    # TRAINING_MODEL_PATH = "dslim/distilbert-NER" #model for finetuning
    # OUTPUT_DIR = os.path.join(PROJECT_DIR, "output", "distilibert") #directory to save the trained model
    # LABEL_ENCODE_DATA_PATH = os.path.join(PROJECT_DIR, 'dags', 'processed', 'label_encoder_data.json')
    # TEST_DATA_PATH = os.path.join(PROJECT_DIR, 'dags', 'processed', 'test_data')
    # train_mapped = load_from_disk(os.path.join(PROJECT_DIR, "dags", "processed", "train_data"))
    # mlflow.set_tracking_uri('http://127.0.0.1:8080')

    dagshub.init("pii-data","gvk7663",mlflow=True)
    mlflow.start_run()
    client = MlflowClient()
