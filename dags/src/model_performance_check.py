...
def check_performance(**kwargs):
    ...
    if results:
        precision, recall, f1, metrics_model_decay, _ = results
        ...
        logging.info(f"Precision: {precision}, Recall: {recall}, F1: {f1}, Model Decay Metrics: {metrics_model_decay}")
        ...
        logging.error("No data received from 'inference' task")